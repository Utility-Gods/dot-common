<div class="flex flex-col gap-4 py-6 mx-auto max-w-7xl sm:px-6 lg:px-8">
    ...
    <h2 class="text-lg font-bold">Collection of Routine Information</h2>

    <p>This website track basic information about their visitors. This information includes, but is not limited to, IP addresses, browser details, timestamps and referring pages. None of this information can personally identify specific visitors to this website. The information is tracked for routine administration and maintenance purposes.</p>
    ...
    <h2 class="text-lg font-bold">Advertisement and Other Third Parties</h2>
    ...
    <h2 class="text-lg font-bold">Links to Third Party Websites</h2>
    ...
    <p>For any questions or concerns regarding the privacy policy, please send us an email to contact@utilitygods.com.</p>
</div>